...
const DEFAULT_SPOTS: CheckinSpotRecord[] = [
  ...
  {
    id: "seed-ao-nang-night-market",
    name: "奥南夜市 Ao Nang Night Market",
    category: "其他",
    description: "奥南海滩边的人气夜市，紧邻诺帕拉塔拉海滩与 KFC，从奥南步行即可到。泰式小吃、烧烤海鲜和热带果汁摊一字排开，价格亲民，入夜后边逛边吃最有氛围。",
    image: "/checkin-spots/ao-nang-night-market.jpg",
    lat: 8.0432,
    lng: 98.8114,
    user: "Lenakids 领队",
    createdAt: "2026-06-20T07:10:00.000Z",
    address: "Ao Nang Landmark Night Market, Noppharat Thara, Ao Nang, Mueang Krabi, Krabi",
    google_maps_url: "https://www.google.com/maps/search/?api=1&query=8.0432,98.8114",
    owner_token_hash: null,
    is_seed: true,
  },
  {
